...
export default function Experience() {
  return (
    <Section id="experience">
      ...
      <ScrollReveal
        direction="down" once={true}  duration={1} margin="-50px 0px"
        className="text-3xl md:text-4xl font-bold mb-16 text-center"
      >
        <h1>Professional <span className="bg-gradient-to-r text-transparent bg-clip-text from-blue-400 to-purple-500">Journey</span></h1>
      </ScrollReveal>
