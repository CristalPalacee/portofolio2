...
const About = () => {
  ...
  return (
    <section id="about" className="relative w-full h-full p-10 overflow-hidden">

   

      <div className="container mx-auto sm:max-w-5xl px-2 lg:px-6 md:px-12 lg:max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl drop-shadow-[0_0_10px_rgba(59,130,246,0.5)] text-shadow-purple-600 md:text-4xl font-bold text-white mb-6 leading-tight">
            ...
            <p className="text-gray-400 lg:text-lg md:text-md leading-relaxed mb-6">
              Hai Saya adalah seorang Frontend Developer yang berbasis di Indonesia.
